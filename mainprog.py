...
def main():
    ...
    print('XQuantidade de pessoas que fizeram o teste:', Total_pessoas)
    print('XQuantidade de pessoas do sexo masculino:' , calculoQtd(Homens), porcentagem(calculoQtd(Homens),Total_pessoas))
    print('XQuantidade de pessoas do sexo feminino:' , calculoQtd(Mulheres), porcentagem(calculoQtd(Mulheres), Total_pessoas))
    print('XQuantidade de pessoas que testaram positivo:', calculoQtd(Positivos))
    ...
    print('XQuantidade de mulheres, acima de 50 anos, assintomáticas:', calculoQtd(finder(mulheres50anos, 'Assintomáticas')), porcentagem(calculoQtd(finder(mulheres50anos, 'Assintomáticas')), Total_pessoas) )
